...
MCP_FEEDS = [
    ...
    FeedSource(
        id="cloudflare-mcp",
        name="Cloudflare MCP",
        url="https://blog.cloudflare.com/tag/model-context-protocol/rss/",
        include_all=True,
        default_author="Cloudflare",
    ),
    FeedSource(
        id="cloudflare-blog",
    ...
    FeedSource(
        ...
        include_all=True,
        default_author="The New Stack",
    ),
    FeedSource(
        id="jon-udell",
        name="Jon Udell Blog",
        url="https://blog.jonudell.net/feed/",
        include_all=True,
        default_author="Jon Udell",
    )
]
